      ...
      <div className="w-full max-w-lg">
        ...
        <div className="glass p-12 rounded-[3.5rem] space-y-10 relative overflow-hidden">
          ...
          <div className="text-center space-y-3">
            <h2 className="text-4xl font-black tracking-tight text-text-main">Welcome Back</h2>
            <p className="text-text-muted text-lg font-medium">Secure authentication to your workspace.</p>
          </div>
          ...
          <div className="text-center pt-4">
            <p className="text-text-muted font-medium">
              Need access?{' '}
              <Link to="/register" className="text-accent font-black hover:text-primary transition-colors underline-offset-4 hover:underline">
                Create Account
              </Link>
            </p>
          </div>
